...
@Repository
@Deprecated
public class CallRepositoryOld {   // TODO: extends AbstractRepository

    final static private Logger log = LoggerFactory.getLogger(CallRepositoryOld.class);
    ...
    @Autowired
    public CallRepositoryOld(DataSource dataSource, AreasRepository areasRepository) {
