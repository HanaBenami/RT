...
public class ContactRepository extends AbstractTypeSyncedWithHashavshevetRepository<Contact> implements RepositoryInterface<Contact> {
    ...
    protected int updateItemDetailsInStatement(PreparedStatement preparedStatement, Contact contact) throws SQLException {
        ...
        fieldsCounter++;
        preparedStatement.setString(fieldsCounter, NullPointerExceptionWrapper.getWrapper(contact, Contact::getNotes, ""));
